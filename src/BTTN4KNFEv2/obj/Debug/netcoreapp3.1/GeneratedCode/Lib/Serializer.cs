...
namespace BTTN4KNFE
{
    ...
    public class Serializer
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        /// <summary>
        /// Serializes a SendNFERequest object to Json string.
        /// </summary>
        /// <param name="value">The target object to be serialized.</param>
        /// <returns>The serialized Json string.</returns>
        public static string ToString(SendNFERequest value)
        {
            s_ensure_string_builder();
            ToString_impl(value, s_stringBuilder, in_json: false);
            return s_stringBuilder.ToString();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        /// <summary>
        /// Serializes a SendNFEResponse object to Json string.
        /// </summary>
        /// <param name="value">The target object to be serialized.</param>
        /// <returns>The serialized Json string.</returns>
        public static string ToString(SendNFEResponse value)
        {
            s_ensure_string_builder();
            ToString_impl(value, s_stringBuilder, in_json: false);
            return s_stringBuilder.ToString();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        /// <summary>
        /// Serializes a BTTNFEBodyPart object to Json string.
        /// </summary>
        /// <param name="value">The target object to be serialized.</param>
        /// <returns>The serialized Json string.</returns>
        public static string ToString(BTTNFEBodyPart value)
        {
            s_ensure_string_builder();
            ToString_impl(value, s_stringBuilder, in_json: false);
            return s_stringBuilder.ToString();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void ToString_impl(SendNFERequest value, StringBuilder str_builder, bool in_json)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void ToString_impl(SendNFEResponse value, StringBuilder str_builder, bool in_json)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void ToString_impl(BTTNFEBodyPart value, StringBuilder str_builder, bool in_json)
        {
