...
namespace BTTN4KNFE
{
    ...
    /// <summary>
    /// A .NET runtime object representation of BTTGenericCredential_EnvelopeSeal defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct BTTGenericCredential_EnvelopeSeal
    {
        
        ///<summary>
        ///Initializes a new instance of BTTGenericCredential_EnvelopeSeal with the specified parameters.
        ///</summary>
        public BTTGenericCredential_EnvelopeSeal(string hashedThumbprint64 = default(string),string signedHashSignature64 = default(string),string notaryStamp = default(string),List<string> comments = default(List<string>))
        {
        ...
        public static bool operator ==(BTTGenericCredential_EnvelopeSeal a, BTTGenericCredential_EnvelopeSeal b)
        {
        ...
        /// <summary>
        /// Converts the string representation of a BTTGenericCredential_EnvelopeSeal to its
        ...
        /// in input, if the conversion succeeded, or default(BTTGenericCredential_EnvelopeSeal) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out BTTGenericCredential_EnvelopeSeal value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<BTTGenericCredential_EnvelopeSeal>(input);
                return true;
            }
            catch { value = default(BTTGenericCredential_EnvelopeSeal); return false; }
        }
        public static BTTGenericCredential_EnvelopeSeal Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<BTTGenericCredential_EnvelopeSeal>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of BTTGenericCredential_EnvelopeSeal defined in TSL.
    /// </summary>
    public unsafe partial class BTTGenericCredential_EnvelopeSeal_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe BTTGenericCredential_EnvelopeSeal_Accessor(byte* _CellPtr
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        public static unsafe implicit operator BTTGenericCredential_EnvelopeSeal(BTTGenericCredential_EnvelopeSeal_Accessor accessor)
        {
            ...
            return new BTTGenericCredential_EnvelopeSeal(
        ...
        public unsafe static implicit operator BTTGenericCredential_EnvelopeSeal_Accessor(BTTGenericCredential_EnvelopeSeal field)
        {
            byte* targetPtr = null;
...
*(optheader_1 + 0) |= 0x08;
            ...
            }BTTGenericCredential_EnvelopeSeal_Accessor ret;
            
            ret = new BTTGenericCredential_EnvelopeSeal_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(BTTGenericCredential_EnvelopeSeal_Accessor a, BTTGenericCredential_EnvelopeSeal_Accessor b)
        {
