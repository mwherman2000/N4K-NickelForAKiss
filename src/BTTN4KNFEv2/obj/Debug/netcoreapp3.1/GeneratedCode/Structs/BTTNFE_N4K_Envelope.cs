...
*(optheader_2 + 0) |= 0x01;
            ...
            {
            *(float*)targetPtr = field.content.credentialsubjectclaims.Value.kissCompass;
            targetPtr += 4;
            *(BTTN4KPurpose*)targetPtr = field.content.credentialsubjectclaims.Value.purpose;
            targetPtr += 1;
            *(BTTN4KType*)targetPtr = field.content.credentialsubjectclaims.Value.kissType;
            targetPtr += 1;
            *(BTTN4KMood*)targetPtr = field.content.credentialsubjectclaims.Value.mood;
            targetPtr += 1;
            *(bool*)targetPtr = field.content.credentialsubjectclaims.Value.tongue;
            targetPtr += 1;
            *(BTTN4KBodyPart*)targetPtr = field.content.credentialsubjectclaims.Value.targetbodypart;
            targetPtr += 1;
            *(BTTN4KBodyPart*)targetPtr = field.content.credentialsubjectclaims.Value.actualbodypart;
            targetPtr += 1;
...

        {
            ...
            *(int*)targetPtr = field.content.credentialsubjectclaims.Value.coverage;
            targetPtr += 4;
            if(field.content.credentialsubjectclaims.Value.d1approachtime!= null){
                if(field.content.credentialsubjectclaims.Value.d1approachtime.Rank != 1) throw new IndexOutOfRangeException("The assigned array'storage Rank mismatch.");
                if(field.content.credentialsubjectclaims.Value.d1approachtime.GetLength(0) != 150) throw new IndexOutOfRangeException("The assigned array'storage dimension mismatch.");
               fixed(float* storedPtr_4 = field.content.credentialsubjectclaims.Value.d1approachtime)
                   Memory.memcpy(targetPtr, storedPtr_4, (ulong)(600));
            } else {
                Memory.memset(targetPtr, 0, (ulong)(600));
            }
            targetPtr += 600;
            if(field.content.credentialsubjectclaims.Value.d2presstime!= null){
                if(field.content.credentialsubjectclaims.Value.d2presstime.Rank != 1) throw new IndexOutOfRangeException("The assigned array'storage Rank mismatch.");
                if(field.content.credentialsubjectclaims.Value.d2presstime.GetLength(0) != 150) throw new IndexOutOfRangeException("The assigned array'storage dimension mismatch.");
               fixed(float* storedPtr_4 = field.content.credentialsubjectclaims.Value.d2presstime)
                   Memory.memcpy(targetPtr, storedPtr_4, (ulong)(600));
            } else {
                Memory.memset(targetPtr, 0, (ulong)(600));
            }
            targetPtr += 600;
            if(field.content.credentialsubjectclaims.Value.d3sustaintime!= null){
                if(field.content.credentialsubjectclaims.Value.d3sustaintime.Rank != 1) throw new IndexOutOfRangeException("The assigned array'storage Rank mismatch.");
                if(field.content.credentialsubjectclaims.Value.d3sustaintime.GetLength(0) != 150) throw new IndexOutOfRangeException("The assigned array'storage dimension mismatch.");
               fixed(float* storedPtr_4 = field.content.credentialsubjectclaims.Value.d3sustaintime)
                   Memory.memcpy(targetPtr, storedPtr_4, (ulong)(600));
            } else {
                Memory.memset(targetPtr, 0, (ulong)(600));
            }
            targetPtr += 600;
            if(field.content.credentialsubjectclaims.Value.d4releasetime!= null){
                if(field.content.credentialsubjectclaims.Value.d4releasetime.Rank != 1) throw new IndexOutOfRangeException("The assigned array'storage Rank mismatch.");
                if(field.content.credentialsubjectclaims.Value.d4releasetime.GetLength(0) != 150) throw new IndexOutOfRangeException("The assigned array'storage dimension mismatch.");
               fixed(float* storedPtr_4 = field.content.credentialsubjectclaims.Value.d4releasetime)
                   Memory.memcpy(targetPtr, storedPtr_4, (ulong)(600));
            } else {
                Memory.memset(targetPtr, 0, (ulong)(600));
            }
            targetPtr += 600;
            if(field.content.credentialsubjectclaims.Value.d5recoverytime!= null){
                if(field.content.credentialsubjectclaims.Value.d5recoverytime.Rank != 1) throw new IndexOutOfRangeException("The assigned array'storage Rank mismatch.");
                if(field.content.credentialsubjectclaims.Value.d5recoverytime.GetLength(0) != 150) throw new IndexOutOfRangeException("The assigned array'storage dimension mismatch.");
               fixed(float* storedPtr_4 = field.content.credentialsubjectclaims.Value.d5recoverytime)
                   Memory.memcpy(targetPtr, storedPtr_4, (ulong)(600));
            } else {
                Memory.memset(targetPtr, 0, (ulong)(600));
            }
            ...
            if(field.content.credentialsubjectclaims.Value.d1approachcurve!= null){
               ...
               fixed(float* storedPtr_4 = field.content.credentialsubjectclaims.Value.d1approachcurve)
                   Memory.memcpy(targetPtr, storedPtr_4, (ulong)(600));
            } else {
                Memory.memset(targetPtr, 0, (ulong)(600));
            }
            ...
            if(field.content.credentialsubjectclaims.Value.d2presscurve!= null){
               ...
               fixed(float* storedPtr_4 = field.content.credentialsubjectclaims.Value.d2presscurve)
                   Memory.memcpy(targetPtr, storedPtr_4, (ulong)(600));
            } else {
                Memory.memset(targetPtr, 0, (ulong)(600));
            }
            ...
            if(field.content.credentialsubjectclaims.Value.d3sustaincurve!= null){
               ...
               fixed(float* storedPtr_4 = field.content.credentialsubjectclaims.Value.d3sustaincurve)
                   Memory.memcpy(targetPtr, storedPtr_4, (ulong)(600));
            } else {
                Memory.memset(targetPtr, 0, (ulong)(600));
            }
            ...
            if(field.content.credentialsubjectclaims.Value.d4releasecurve!= null){
               ...
               fixed(float* storedPtr_4 = field.content.credentialsubjectclaims.Value.d4releasecurve)
                   Memory.memcpy(targetPtr, storedPtr_4, (ulong)(600));
            } else {
                Memory.memset(targetPtr, 0, (ulong)(600));
            }
            ...
            if(field.content.credentialsubjectclaims.Value.d5recoverycurve!= null){
               ...
               fixed(float* storedPtr_4 = field.content.credentialsubjectclaims.Value.d5recoverycurve)
                   Memory.memcpy(targetPtr, storedPtr_4, (ulong)(600));
            } else {
                Memory.memset(targetPtr, 0, (ulong)(600));
            }
