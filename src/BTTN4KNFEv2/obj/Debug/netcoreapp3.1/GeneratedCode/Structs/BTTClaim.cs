...
namespace BTTN4KNFE
{
    ...
    /// <summary>
    /// A .NET runtime object representation of BTTClaim defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct BTTClaim
    {
        
        ///<summary>
        ///Initializes a new instance of BTTClaim with the specified parameters.
        ///</summary>
        public BTTClaim(string key = default(string),string value = default(string),List<BTTKeyValuePair> attribute = default(List<BTTKeyValuePair>),List<List<BTTKeyValuePair>> attributes = default(List<List<BTTKeyValuePair>>))
        {
        ...
        public static bool operator ==(BTTClaim a, BTTClaim b)
        {
        ...
        public List<BTTKeyValuePair> attribute;
        
        public List<List<BTTKeyValuePair>> attributes;
        
        /// <summary>
        /// Converts the string representation of a BTTClaim to its
        ...
        /// in input, if the conversion succeeded, or default(BTTClaim) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out BTTClaim value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<BTTClaim>(input);
                return true;
            }
            catch { value = default(BTTClaim); return false; }
        }
        public static BTTClaim Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<BTTClaim>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of BTTClaim defined in TSL.
    /// </summary>
    public unsafe partial class BTTClaim_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe BTTClaim_Accessor(byte* _CellPtr
            ...
            )
        {
            ...
            ResizeFunction = func;
                ...
                (ptr,ptr_offset,delta)=>
                {
                    ...
                    this.m_ptr = this.ResizeFunction(this.m_ptr, ptr_offset + substructure_offset, delta);
                    return this.m_ptr + substructure_offset;
                });        attribute_Accessor_Field = new BTTKeyValuePair_AccessorListAccessor(null,
                (ptr,ptr_offset,delta)=>
                {
                    int substructure_offset = (int)(ptr - this.m_ptr);
                    this.m_ptr = this.ResizeFunction(this.m_ptr, ptr_offset + substructure_offset, delta);
                    return this.m_ptr + substructure_offset;
                });        attributes_Accessor_Field = new BTTKeyValuePair_AccessorListAccessorListAccessor(null,
                (ptr,ptr_offset,delta)=>
                {
                    int substructure_offset = (int)(ptr - this.m_ptr);
                    this.m_ptr = this.ResizeFunction(this.m_ptr, ptr_offset + substructure_offset, delta);
...
targetPtr += *(int*)targetPtr + sizeof(int);}
        ...
        BTTKeyValuePair_AccessorListAccessor attribute_Accessor_Field;
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        ///</summary>
        public unsafe BTTKeyValuePair_AccessorListAccessor attribute
        {
            get
            {
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        BTTKeyValuePair_AccessorListAccessorListAccessor attributes_Accessor_Field;
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        ///</summary>
        public unsafe BTTKeyValuePair_AccessorListAccessorListAccessor attributes
        {
            get
            {
...
targetPtr += *(int*)targetPtr + sizeof(int);
        ...
        public static unsafe implicit operator BTTClaim(BTTClaim_Accessor accessor)
        {
            ...
            List<BTTKeyValuePair> _attribute = default(List<BTTKeyValuePair>);
            ...
            List<List<BTTKeyValuePair>> _attributes = default(List<List<BTTKeyValuePair>>);
        ...
        public unsafe static implicit operator BTTClaim_Accessor(BTTClaim field)
        {
            byte* targetPtr = null;
...
*(optheader_1 + 0) |= 0x04;
            ...
            }BTTClaim_Accessor ret;
            
            ret = new BTTClaim_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(BTTClaim_Accessor a, BTTClaim_Accessor b)
        {
