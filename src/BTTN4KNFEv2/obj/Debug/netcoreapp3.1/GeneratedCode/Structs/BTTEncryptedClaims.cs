...
namespace BTTN4KNFE
{
    ...
    /// <summary>
    /// A .NET runtime object representation of BTTEncryptedClaims defined in TSL.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public partial struct BTTEncryptedClaims
    {
        
        ///<summary>
        ///Initializes a new instance of BTTEncryptedClaims with the specified parameters.
        ///</summary>
        public BTTEncryptedClaims(string ciphertext16 = default(string),string alg = default(string),string key = default(string))
        {
        ...
        public static bool operator ==(BTTEncryptedClaims a, BTTEncryptedClaims b)
        {
        ...
        /// <summary>
        /// Converts the string representation of a BTTEncryptedClaims to its
        ...
        /// in input, if the conversion succeeded, or default(BTTEncryptedClaims) if the conversion
        /// failed. The conversion fails if the input parameter is null or String.Empty, or is 
        /// not of the correct format. This parameter is passed uninitialized. 
        /// </param>
        /// <returns>True if input was converted successfully; otherwise, false.</returns>
        public unsafe static bool TryParse(string input, out BTTEncryptedClaims value)
        {
            try
            {
                value = Newtonsoft.Json.JsonConvert.DeserializeObject<BTTEncryptedClaims>(input);
                return true;
            }
            catch { value = default(BTTEncryptedClaims); return false; }
        }
        public static BTTEncryptedClaims Parse(string input)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<BTTEncryptedClaims>(input);
        }
        /// <summary>
    ...
    /// <summary>
    /// Provides in-place operations of BTTEncryptedClaims defined in TSL.
    /// </summary>
    public unsafe partial class BTTEncryptedClaims_Accessor : IAccessor
    {
        ///<summary>
        ...
        internal unsafe BTTEncryptedClaims_Accessor(byte* _CellPtr
        ...
        public static unsafe implicit operator BTTEncryptedClaims(BTTEncryptedClaims_Accessor accessor)
        {
            
            return new BTTEncryptedClaims(
        ...
        public unsafe static implicit operator BTTEncryptedClaims_Accessor(BTTEncryptedClaims field)
        {
            byte* targetPtr = null;
        ...
        }else
        {
            *(int*)targetPtr = 0;
            ...
            }BTTEncryptedClaims_Accessor ret;
            
            ret = new BTTEncryptedClaims_Accessor(tmpcellptr, null);
            
            return ret;
        }
        
        public static bool operator ==(BTTEncryptedClaims_Accessor a, BTTEncryptedClaims_Accessor b)
        {
